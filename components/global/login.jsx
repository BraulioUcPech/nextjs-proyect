            ...
            <div className="sing-up-body">
              ...
              >
                <div className="col-md-12">
                  <label htmlFor="email" for="pEmailId" className="form-label">
                    {block.email.heading}
                  </label>
                  <input
                    type="email"
                    ...
                    required
                    placeholder={
                      block?.email?.placeholder || "Enter your email"
                    }
                  />
                </div>
                <div className="col-md-12">
                  <label htmlFor="password" className="form-label">
                    {block?.password?.heading || "Password"}
                  </label>
                  <input
                    type="password"
                    className="form-control"
                    id="password"
                    placeholder={
                      block?.password?.placeholder || "Enter your password"
                    }
                    value={password}
