...
export default function GlobalSignup({ block, dataBinding }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirigir o hacer lo que sea necesario después del registro
    } catch (error) {
      ...
      if (error.message.includes("rate limit exceeded")) {
        ...
        setError(
          "Error al enviar el correo de confirmación. Por favor, verifica tu dirección de correo electrónico."
        );
      } else {
          ...
          <div className="col-lg-7 mx-auto">
            <div className="sing-up-body">
              ...
              <form
                ...
                className="sing-up-items row gy-4 gx-3"
              >
                ...
                <div className="col-md-12">
                  ...
                  >
                    ...
                    {loading ? "Loading..." : block.form.sign_up_text}
                  </button>
                </div>
